...
// // const coachRoutes = require('./routes/coach.js'); // Existing coach routes for registration/login
...
// // CORS configuration options
// const corsOptions = {
//     origin:  'http://localhost:3000', // Replace with your frontend URL during deployment
//     methods: ['GET', 'POST', 'PUT', 'DELETE'], // Allowed methods
//     allowedHeaders: ['Content-Type', 'Authorization'], // Allowed headers
//     credentials: true, // Allow credentials (cookies, authorization headers, etc.)
// };
...
// CORS configuration options
const corsOptions = {
    origin: 'https://fitzhore.vercel.app', // Replace with your frontend deployment URL
    methods: ['GET', 'POST', 'PUT', 'DELETE'], // Allowed methods
    allowedHeaders: ['Content-Type', 'Authorization'], // Allowed headers
    credentials: true, // Allow credentials (cookies, authorization headers, etc.)
};
